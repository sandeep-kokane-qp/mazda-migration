...
public class BatchConfig {
	...
	private PagingQueryProvider createQueryProvider() {
		...
		queryProvider.setFromClause("Qpro_VehicleSales.mazdaus.srcVehicleSalesData AS src "
				+ " JOIN Qpro_VehicleSales.ods.Vehicle AS vh ON vh.VIN = src.VIN AND vh.ProgramID=11");
	...
	ItemWriter<Vehicle> itemWriter() {
		...
		String sqlString = "UPDATE Qpro_VehicleSales.mazdaus.srcVehicleSalesData" + " SET VehicleID = :vehicleID"
